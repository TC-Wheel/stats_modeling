...
dir=[pwd,'/Data/Micrographs']
imds = imageDatastore(dir,'FileExtensions','.jpg','IncludeSubfolders',true,'LabelSource','foldernames');
...
[imdsTrain,imdsTest] = splitEachLabel(imds,0.5,'randomized');
